...
public class Grabber {
  ...
  public Motor leftSlide, rightSlide, fourBar;
  public Servo claw, v4bLeft, v4bRight;

  public Grabber(Motor l, Motor r, Motor f, Servo g) {
    leftSlide = l;
    rightSlide = r;
    fourBar = f;
    claw = g;
  ...
  public void raiseLow() {
    setV4B_FRONT();
    raiseToPosition(LOW, 0.3);
    armRested = false;
  }

  public void restArm() {
    raiseToPosition(REST, 0.3);
    armRested = true;
  }
  ...
  public void raiseToPositionRight(int pos, double power){
    rightSlide.setTarget(pos);
    rightSlide.retMotorEx().setTargetPositionTolerance(3);
    rightSlide.toPosition();
    rightSlide.setPower(power);
  ...
  public void conePickUpPos() {
    claw.setPosition(CLAW_OPEN);
  }

  public void setV4B_FRONT() {
    fourBar.setTarget(275);
    fourBar.retMotorEx().setTargetPositionTolerance(3);
    fourBar.toPosition();
