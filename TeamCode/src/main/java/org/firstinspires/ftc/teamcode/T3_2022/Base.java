...
import org.firstinspires.ftc.teamcode.T3_2022.Modules.Camera.Camera;
import org.firstinspires.ftc.teamcode.T3_2022.Modules.Drive;
import org.firstinspires.ftc.teamcode.T3_2022.Modules.Grabber;
...
public abstract class Base extends LinearOpMode {
  ...
  public void initHardware(int xPos, int yPos, int angle, OpMode m) throws InterruptedException {
    ...
    Servo vbl = hardwareMap.get(Servo.class, "vbl");
    Servo vbr = hardwareMap.get(Servo.class, "vbr");
    ...
    grabber = new Grabber(ls, rs, vbl, vbr, s, t);
